# __str__  一个对象的描述字符串, 更加方便用户阅读, 对用户更友好
# __repr__  当我们在交互模式下, 直接执行某个变量, 就会输出对应信息
# __call__ 使得“对象”具备当做函数，来调用的能力
# __setItem__ 可以对一个实例对象进行索引操作
# __setspice__ 可以对一个实例对象进行切片操作 
# __eq__
# __ne__
# __lt__
# __le__
...
# __ge__
# __bool__
# __getitem__方法 __iter__ 怎样让我们自己创建的对象可以使用for in 进行遍历?
# __next__ 怎样让我们自己创建的对象可以使用next函数进行访问?
